...
function App() {
  ...
  return (
    ...
    <h1 className="text-4xl font-bold text-blue-600 animate-pulse text-center">
      TODO List App
    </h1>
    ...
    <div className="flex flex-col md:flex-row items-center space-y-4 md:space-x-4">
      <input
        ...
        className="w-full md:w-80 px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
      />
      <button
    ...
    <ul className="w-full md:w-96 space-y-3">
      {todos.map((todo) => (
        <li
          key={todo.id}
    ...
    <div className="mt-6">
      <p className="text-gray-500 text-sm text-center">Manage your tasks efficiently 💡</p>
    </div>
  </div>
